...
/**
 * Brand glyphs (removed from lucide-react) with a lucide-compatible API:
 * accept `size` plus standard SVG props so they can be swapped in anywhere
 * a Lucide icon is used.
 */
